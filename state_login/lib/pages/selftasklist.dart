...
class _SelfTaskListState extends State<SelfTaskList> {
                                            ...
                                            itemBuilder: (context){
                                              return ["Complete","Delete"].map((e) {
                                                return PopupMenuItem(
                                                  child: Text(e),
                                                  value: [widget.id,snapshot.data.elementAt(index).title,snapshot.data.elementAt(index).date],
                                                );
                                              } ).toList();
                                            }
                                          ),
                                    ...
                                    child: Card(
                                      ...
                                      child: ListTile(
                                        ...
                                        trailing: IconButton(
                                          ...
                                          onPressed: (){
                                            deleteTask(widget.id, snapshot.data.elementAt(index).title, snapshot.data.elementAt(index).date);
                                          },
                                        ),
                                      ),
                                    ),
  ...
  void performAction(List task)async{
    if(await completeSelfTask(task.elementAt(0), task.elementAt(1), task.elementAt(2))){
      // print('complete');
      setState(() {
          ...
          return Container(
            ...
            child: ListView(
              ...
              Row(
                ...
                children: [
                Text('Self Tasks',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 25.0,color: Colors.black),),
              ...
              RichText(
                text:TextSpan(
                  ...
                  TextSpan(text: ' Self tasks',style: TextStyle(color: Colors.green)),
