          ...
          return Container(
            ...
            child: ListView(
              ...
              Row(
                ...
                children: [
                Text('Your Work',style: TextStyle(fontWeight:FontWeight.bold,fontSize: 25.0,color: Colors.black),),
              ...
              RichText(
                text:TextSpan(
                  ...
                  TextSpan(text: ' assigned to you',style: TextStyle(color: Colors.green)),
                ]) 
              )
            ],),
          );
